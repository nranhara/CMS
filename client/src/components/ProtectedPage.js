      ...
      <div>
        ...
        <div className="flex justify-between items-center bg-primary p-2">
          <h1
            ...
            onClick={() => navigate("/")}
          >
            Wellcome To DoNation Charity Management System
          </h1>
          ...
          <div className="bg-white py-2 px-5 rounded flex gap-3 items-center">
            ...
            <span
              ...
              onClick={() => {
                if (user.role === "user") {
                  navigate("/profile");
                } else if (user.role === "MPmanager") {
                  navigate("/MPmanager");
                } else if (user.role === "InventoryManager") {
                  navigate("/InventoryManager");
                } else if (user.role === "CRmanager") {
                  navigate("/CRmanager");
                } else if (user.role === "CareerManager") {
                  navigate("/CareerManager");
                } else if (user.role === "DonationManager") {
                  navigate("/DonationManager");
                } else if (user.role === "FinancialManager") {
                  navigate("/FinancialManager");
                } else if (user.role === "EventsManager") {
